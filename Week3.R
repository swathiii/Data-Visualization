...
#plotting a simple graph : sinusoidal function like last week's

t<- seq(from=0, to=10, by=0.1)
y<-sin(t)

#we have generated two vectors, which we can use to create a data frame
#using ggplot2, we can plot them in scatterplot 
